...
# HUOM: repo-osoite päivitetään neutraaliin osoitteeseen ennen julkaisua (04-preflight.md).
cd "$(dirname "$0")/.." || exit 1
...
ref=$(gh api repos/original-private-account/eikaisiina/traffic/popular/referrers 2>/dev/null)
